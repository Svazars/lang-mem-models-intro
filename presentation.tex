...
\begin{itemize}
    ...
    \item инженер по производительности, выжимающий максимальную скорость ценой хрупкого кода\footnote<4->{\tinyКрасная зона в терминах \url{https://youtu.be/p2b4JHESEOc}}
